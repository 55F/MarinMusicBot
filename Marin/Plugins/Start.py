...
from Marin import ASSIDS, BOT_ID, MUSIC_BOT_NAME, OWNER_ID, SUDOERS, app
from Marin import boottime as bot_start_time
from Marin import db, random_assistant
from Marin.Core.PyTgCalls import Marin
from Marin.Database import (add_nonadmin_chat, add_served_chat,
...
from Marin.Decorators.admins import ActualAdminCB
from Marin.Decorators.permission import PermissionCheck
from Marin.Inline import (custommarkup, dashmarkup, setting_markup,
                          setting_markup2, start_pannel, usermarkup, volmarkup)
from Marin.Utilities.assistant import get_assistant_details
from Marin.Utilities.ping import get_readable_time
...
async def start_markup_check(_, CallbackQuery):
    ...
    if command == "LV":
        ...
        volume = 25
        try:
            await Marin.pytgcalls.change_volume_call(c_id, volume)
    ...
    if command == "DIT":
        ...
        await CallbackQuery.answer(
            f"Marin Disk Usage: {diske}%", show_alert=True
        )
