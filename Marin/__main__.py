...
from config import (LOG_GROUP_ID, LOG_SESSION, STRING1, STRING2, STRING3,
                    STRING4, STRING5)
from Marin import (ASS_CLI_1, ASS_CLI_2, ASS_CLI_3, ASS_CLI_4, ASS_CLI_5,
                   ASSID1, ASSID2, ASSID3, ASSID4, ASSID5, ASSNAME1, ASSNAME2,
                   ASSNAME3, ASSNAME4, ASSNAME5, BOT_ID, BOT_NAME, LOG_CLIENT,
                   OWNER_ID, app)
from Marin.Core.Clients.cli import LOG_CLIENT
from Marin.Core.PyTgCalls.Marin import (pytgcalls1, pytgcalls2, pytgcalls3,
                                        pytgcalls4, pytgcalls5)
from Marin.Database import (get_active_chats, get_active_video_chats,
                            get_sudoers, is_on_off, remove_active_chat,
                            remove_active_video_chat)
from Marin.Inline import private_panel
from Marin.Plugins import ALL_MODULES
from Marin.Utilities.inline import paginate_modules
...
async def initiate_bot():
    ...
    console.print(
        "[bold green]Congrats!! Marin Music Bot has started successfully!\n"
    )
    try:
    ...
    if STRING1 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_1.join_chat("OfficialMarin")
            await ASS_CLI_1.join_chat("SupportSupport")
        except:
            pass
    ...
    if STRING2 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_2.join_chat("off")
            await ASS_CLI_2.join_chat("MarinSupport")
        except:
            pass
    ...
    if STRING3 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_3.join_chat("OfficialMarin")
            await ASS_CLI_3.join_chat("MarinSupport")
        except:
            pass
    ...
    if STRING4 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_4.join_chat("OfficialMarin")
            await ASS_CLI_4.join_chat("MarinSupport")
        except:
            pass
    ...
    if STRING5 != "None":
        try:
            ...
            return
        try:
            await ASS_CLI_5.join_chat("OfficialMarin")
            await ASS_CLI_5.join_chat("MarinSupport")
        except:
            pass
    ...
    if LOG_SESSION != "None":
        try:
            ...
            return
        try:
            await LOG_CLIENT.join_chat("OfficialMarin")
            await LOG_CLIENT.join_chat("MarinSupport")
        except:
            pass
    console.print(f"└[red] Marin Music Bot Boot Completed.")
    if STRING1 != "None":
