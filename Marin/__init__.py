...
from Marin.Core.Clients.cli import (ASS_CLI_1, ASS_CLI_2, ASS_CLI_3, ASS_CLI_4,
                                    ASS_CLI_5, LOG_CLIENT, app)
from Marin.Utilities.changers import time_to_seconds
from Marin.Utilities.tasks import install_requirements
...
async def initiate_bot():
    ...
    with console.status(
        "[magenta] Marin Music Bot Booting...",
    ) as status:
